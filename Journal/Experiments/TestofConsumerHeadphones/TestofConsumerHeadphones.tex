...
\begin{figure}[H]
	...
	\centering
	\includegraphics[width=1\textwidth]{../Journal/Experiments/TestofConsumerHeadphones/Plots/ComparedConusmerHPAppSub1}
	\end{subfigure}
%	\hfill
	\begin{subfigure}[b]{.48\textwidth}
	\centering
	\includegraphics[width=1\textwidth]{../Journal/Experiments/TestofConsumerHeadphones/Plots/ComparedConusmerHPAppSub2}
	\end{subfigure}
	\begin{subfigure}[b]{.48\textwidth}
	\centering
	\includegraphics[width=1\textwidth]{../Journal/Experiments/TestofConsumerHeadphones/Plots/ComparedConusmerHPAppSub3}
	\end{subfigure}
%	\hfill
	\begin{subfigure}[b]{.48\textwidth}
	\centering
	\includegraphics[width=1\textwidth]{../Journal/Experiments/TestofConsumerHeadphones/Plots//ComparedConusmerHPAppSub4}
	\end{subfigure}
	\label{4waycompareconsumer}
	\caption{All tests plotted with fitted curves. }
\end{figure}
...
\begin{figure}[H]
	...
	\caption{Comparison of the Denon, B\&O H8 Bose QC15 Bose QC25.}
...
%\begin{figure}[H]
%	\centering
%	\tikzsetnextfilename{ComparedConusmerHPAppSub1}	\input{../Journal/Experiments/TestofConsumerHeadphones/Plots/CunsumerHpSubplot1(fig).tex}
%	\caption{hej}
%\end{figure}
