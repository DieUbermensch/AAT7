...
\subsection{Procedure}
	...
	\begin{enumerate}
		...
		\end{itemize}
		\item Rename generated file "GeneratedANC" according to headphone tested, and whether or not ANC was enabled. E.g. "Denonon[1].wav" for the first test of the Denon AH GC20 headhpone with ANC enabled. Names in "evaluatePerformance.m"-script is named accordingly.
				\begin{itemize}
...
\begin{itemize}
	\item "Denonon[i].wav"		(Denon AH GC20 w/ ANC)
...
This is done by finding the frequency response of the "signal", which the cross correlation between e.g. "Denonon[i].wav" and "Denonon[i].wav" This is done by taking the FT of the cross correlated signals, seen in \autoref{FrequencyResponseEq2}.
...
\begin{figure}[H]
	...
	\caption{Comparison between Denon AH GC20(Blue), Bose QuietComfort 15(Orange), Bose QuietComfort 25(Yellow), B\&O BEOPLAY H8(Green)  and more to come....}
