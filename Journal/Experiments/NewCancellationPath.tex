\section{DT 770 Cancellation Path} \label{sec:DT770CPjournal}

All files from this appendix can be found in folder: \\
\path{Attachment://Appendix H - DT 770 Cancellation Path}
...
\begin{table}[h]
	...
	\label{tab:UsedEquipmentListningCPNew}
\end{table}
...
\begin{table}[H]
	...
	\begin{tabular}{ c c c } \toprule
		...
		4	&	Knowles FG-23329 Microphone					& $+$ 0.0/$-$ 0.5 dBSPL	\cite{Knowles}	\\ 
		6	&	Roland Edirol UA-25EX Audio Capture			& $+$ 0.0/$-$ 1.0 dB \cite{UA25EXTol} \\
		%6	&	B\&K Microphone Power Supply Type 2804		& 2 \%	\\ 
		9	&	B\&K Sound Intensity Calibrator Type 3541	& $\pm$ 0.2 dBSPL \cite{BK3541Tol}	\\ \bottomrule
			&	Total tolerance								& $+$ 1.7/$-$ 3.2 dBSPL	\\ \bottomrule	
	\end{tabular}
