...
=======
\section{DT770 Cancellation Path Impulse Response} \label{sec:CPjournalDT770}
>>>>>>> 9dfdf1570daca87b358911ba670e01b1ed1041a9
\subsection{Purpose}
...
\begin{itemize}
	...
	\item Item 4 (Edirol audio capture):
		\begin{itemize}
...
If  a discontinuity in the recorded signal(s) occurs, then discard that recording and reperform the experiment.
...
\end{enumerate}
From performing of the experiment, two files has been generated:
\begin{itemize}
	\item errMic.wav 
	\item spmMic.wav
\end{itemize}
...
An example showing outputted errMic and spmMic is shown in  \autoref{DT770AmplitudePlotCancellationPath}.

\begin{figure}[H]
	\centering
	\tikzsetnextfilename{CancellationPathAmplitudePlot3}
