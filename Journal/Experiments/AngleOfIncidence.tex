...
\begin{itemize}
	...
	\item For the speakerMic calibration is made using a earplug cut in half and fitted around the adaptor. This simple adaptor allows the B\&K 4230 to be used as calibrator. The measured output level is 84.37, and should have been 53.5 dB . Therefore all measurements are multiplied by 0.029 to get a calibrated signal in Matlab. 
\end{itemize}
