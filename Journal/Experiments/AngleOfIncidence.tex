...
\todoMikkel{I have no illustrator and that HATS is sad, because it's missing its nose :( }
\begin{figure}[H]
	\centering
...
\end{figure}
\todoMikkel{Can you make that line thing that someone did in the article? - for all 3 figures}
