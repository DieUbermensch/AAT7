...
\begin{itemize}
	...
	\item Calibration signal yields a spike at 101.3 dB SPL $@$ 1 $k$Hz, which requires a 0.4121 adjustment
\end{itemize}
...
\begin{figure}[H]
	...
	\caption{Impulse Response plot of the headphone transfer function. Impulse response 1 (\textcolor{MATLABblue}{---}), 
