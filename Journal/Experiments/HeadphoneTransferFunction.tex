...
\begin{itemize}
	\item 93.6 dB due to being a pressure field. 1 $k$Hz is used as calibration signal. %\todoOliver{again calibration??. Oliver: It's what is says on the calibrator. It's not the HATS ear this time}
...
Oliver: Yeah it's from reducing the plot when tikzing, not sure what can be done about it.}
...
\begin{itemize}
	\item Placement of headphones % \todoOliver{again do we just mean headphone? Yes we do}	
