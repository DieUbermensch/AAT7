...
%\begin{figure}[H]
%	\centering
%	\tikzsetnextfilename{CancellationPathFrequencyResponse}
%	\input{figures/CancellationPath_MATLAB_Figures/CancellationPathFrequencyResponse.tex}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.85\textwidth]{HeadPhone_MATLAB_Figures/HeadPhoneFrequencyResponse.png}
	\caption{Frequency Response plot of the headphones (NOT TIKZ).}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.85\textwidth]{HeadPhone_MATLAB_Figures/HeadPhoneImpulseResponse.png}
	\caption{Impulse Response plot of the headphones (NOT TIKZ).}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.85\textwidth]{HeadPhone_MATLAB_Figures/HeadPhonesTimeDecay.png}
