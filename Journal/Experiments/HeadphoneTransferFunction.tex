...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.65\textwidth]{HeadPhone_MATLAB_Figures/HeadPhoneAmplitudePlot.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.65\textwidth]{HeadPhone_MATLAB_Figures/HeadPhoneFrequencyResponse.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.65\textwidth]{HeadPhone_MATLAB_Figures/HeadPhoneImpulseResponse.png}
