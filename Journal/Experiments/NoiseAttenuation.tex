...
\begin{figure}[H]
	\centering
<<<<<<< HEAD
	\includegraphics[width=0.9\textwidth]{AttenuationExperiment/figure1.pdf}
	\caption{Box plot of the results from the attenuation experiment.}
=======
...
>>>>>>> 43d6d35085d3a85375a556488d37686dc6fc4665
	\label{fig:ResAttExp}
\end{figure}
...
A given participant's results over different tests are very stable, within +-2,5 dB which was the calibration uncertainty. 
