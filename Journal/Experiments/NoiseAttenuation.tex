...
\begin{table}[h]
	...
	\begin{tabular}{ c c c } \toprule
		...
		5		&  Valdemar with SPL-meter				& 2150-04	\\
...
\item The calibration of the overall noise level was done using a model head with fitted with a microphone conforming with the ISO XX standard. The fluctuation in noise level was allowed to be $\pm$ 4 dB(A) compared to the calibrated level. 
\end{itemize}
