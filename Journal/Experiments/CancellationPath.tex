...
\begin{itemize}
	\item 94 dB (-0.8 dB for adapters) $@$ 250 Hz is used as calibration signal
...
\begin{figure}[H]
	\centering
	\tikzsetnextfilename{CancellationPathImpulseResponseCrop}
...
\begin{figure}[H]
	\centering
	\tikzsetnextfilename{CancellationPathImpulseResponseCompare}
