...
\begin{figure}[H]
	...
	\input{figures/CancellationPath_MATLAB_Figures/CancellationPathAmplitudePlot.tex}
...
The impulse response shows the coefficients of the system, and a file containing all 250 is generated with the name "CoeffientsCP.mat"