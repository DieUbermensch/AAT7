...
This appendix contains documentation regarding the third octave filter bank used in the project. The scripts can be found in \path{CD://Appendix P - Third octave filter ...}
\\
...
\begin{figure}[H]
	...
	\begin{subfigure}[b]{0.45\textwidth}
		...
		\caption{An AM modulated sine with a 100 Hz, 1.000 Hz and 10.000 Hz tone.}
