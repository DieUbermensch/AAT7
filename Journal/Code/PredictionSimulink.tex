...
\begin{figure}[H]
	...
	\caption{Implemented ACF estimator (red) compared with MATLAB \textsuperscript{\textregistered} build in xcorr (blue) - Identical results}
	\label{fig:ACFTest}
\end{figure}
...
\begin{figure}[H]
	...
	\caption{Implemented Levinson Durbin (red) compared with MATLAB \textsuperscript{\textregistered} build in function(blue) - Identical results}
	\label{fig:LDTest}
\end{figure}
...
\todoChristian{Are we adding a path here?}
...
\subsubsection{Automated tests - $N$ \& $O$}
