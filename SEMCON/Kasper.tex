...
\begin{frame}{Introduction}{Summary}		
	\begin{itemize}
		\item ANC attenuate infinitely ideally
		...
		\begin{columns}
			...
			\begin{itemize}
				...
				\begin{itemize}
					...
					\item Overlap O
				\end{itemize}
				\item Wiener hopf equation: $\hat{R}  \bar{a} = -\bar{\hat{r}}_x$
				\begin{itemize}
...
\begin{columns}
	\begin{column}{0.4\textwidth}
		\begin{itemize}
			...
			\item $\hat{x}[n+P]$
			\end{itemize}
			\item CP delayed for compensation of error microphone delay
		\end{itemize}
	\end{column}
	\begin{column}{0.6\textwidth} 
...
\begin{frame}{Methods}{How to test}	
\begin{itemize}
	\item Simulink 
	\item Prediction Gain
	\item Cross correlations 
	\item Not entirely sure what to put here
\end{itemize}
\end{frame}
...
\item Computational cost of System (instructions pr. sample)
	...
	\end{itemize}
	\item Figure missing of different DSP maximum instruction pr sample at 48 kHz
\end{itemize}
