...
{Active Noise Control of Speech in Headphones}

\subtitle{using Linear Prediction}  % could also be a conference name

\date{\today}

\author[Group 761] % optional, use only with lots of authors
{
  Kasper Kiis Jensen, Maxime Démurger\\
  Oliver Palmhøj Jokumsen, Christian Claumarch \\
...
<<<<<<< HEAD
  \finalpage{Kiis for President!}
=======
  \finalpage{Mikkel for president!}
>>>>>>> e62cbe17d7828e3ef50bfbe5e126a41eba23a989
\end{frame}}
%%%%%%%%%%%%%%%%
