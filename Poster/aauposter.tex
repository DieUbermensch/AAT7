...
\documentclass[a0paper,landscape,40pt]{baposter}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
{\color{white}\small 
  ...
  \textit{Acoustics and Audio Technology - 1$^{st}$ Semester - Dept.\ of Electronic Systems, Aalborg University, Denmark}\\
...
\input{Section/MaterialsAndMethods.tex}
\end{posterbox}
...
\begin{posterbox}[name=conclusion,column=3,below=discussion,height=0.3]{Conclusion}
	\input{Section/Conclusion.tex}
\end{posterbox}

\begin{posterbox}[name=Acks,column=3,below=conclusion,above=bottom]{Acknowledgment}
...
\bibitem{SpeechCoding} Wai C. Chu: \emph{Speech Coding Alorithms}, Wiley $1^{st}$ Edition 2013
\bibitem{HansenSnyder} Danielle Moreau and Scott Snyder and Xiaojun Qiu and Laura Brooks and Colin Hansen: \emph{Active Control of Noise and Vibration}, CRC Press $2^{nd}$ Edition 2012
\end{thebibliography}
\end{posterbox}
