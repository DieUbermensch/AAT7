\large
A standard filtered x least mean square (FXLMS) adaptive algorithm is used to find the counter phase signal of the noise. The filter coefficients are adapted using the error measured with microphone (3).
