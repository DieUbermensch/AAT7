...
The algorithm dapts the impulse response of the control filter, outputting a counterphase signal.
...
Where the characteristics of speech are determined in a frame based autocorrelation function (ACF).
