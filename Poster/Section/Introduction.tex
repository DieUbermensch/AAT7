...
\draw (-2.9,1.38) -- (-2.5,1.74) -- (-2.5,0.96) -- (-2.9,1.3);
\node at (-2.64,1.34) {2};


\draw[->,dashed] (-2.5,1.36) node[right=16.5,above=2]{}-- (0.28,1.36);
...
\node[anchor=south west,inner sep=0] at (1.66,0.3) {\includegraphics[width=3cm]{BasicOverview}};

\draw  (2.9,1.65) rectangle (1.9,0.95);

\draw (1.56,1.31) -- (1.9,1.31);
...
The simulated feedforward set-up: reference microphone (1), headphone speaker (2), error microphone (3) and DSP (4).
