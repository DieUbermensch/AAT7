...
\begin{minipage}{.45\columnwidth}
	...
	\end{center}
\vspace{-3mm}
The attenuation for different frequencies for the FXLMS (\textcolor{MATLABblue}{---}) and the LP FXLMS (\textcolor{MATLABred}{---}) systems. The frequency content is not changed much by the predictor, but the attenuation is increased by 30+ dB. 
=======
\begin{minipage}{.43\columnwidth}
\textbf{Frequencyresponse of the two systems}\\
