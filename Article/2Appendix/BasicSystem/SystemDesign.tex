...
\end{figure}  
\todoKiis{I don't think we ever name 1,2,3 and 4 in the appendixes?}
...
In the "real world" simulation HP and CP are sample-by-sample FIR filters with the measured coefficients from \autoref{sec:HPjournal} and  \fxnote{\todoMax{Ref new CP}}. The functions are listed in \autoref{Lst:hpReal} and  \autoref{Lst:cpReal} respectively. 
...
\todoMikkel{autoref to appendix still has a capital A. I prefer small a, Kiss does not care. You decide!}
