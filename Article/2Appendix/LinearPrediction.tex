...
Levinson-Durbin is a method which can be used to estimate the LPCs of a problem, recursively. It is characterized by being power efficient, as it does not directly invert a matrix, but rather estimates it. \todoMikkel{som i strømbesparende? Det er da et helt nyt hensyn at tage her midt i matematikken :D }
...
\todoMikkel{Skal der ikke både bar og hat på det a - så kan iet slettes }
