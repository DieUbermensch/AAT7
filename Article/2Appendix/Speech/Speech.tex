...
This appendix will give a short introduction to speech and will examinate the characteristics of speech. 
...
Signal processing on speech is normally done on a frame by frame basis. The length of the frame is typically chosen such that the characteristics of the speech signal remain constant within a single frame. A typical length of a frame would be 20 $m$s - 30 $m$s where it can be stated that a speech signal is Wide Sense Stationary (WSS).  
