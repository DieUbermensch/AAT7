...
\begin{scope}% layer1
  \begin{scope}[shift={(-14.22335,105.14748)}]% layer1-7
    ...
    % text4401
    \path[fill=black,line join=miter,line cap=butt,line width=0.800pt]
      (172.6317,681.3109) node[above right] (text4401) {PC};

    % text4405
    \path[fill=black,line join=miter,line cap=butt,line width=0.800pt]
      (381.7714,721.5567) node[above right] (text4405) {RME FireFace};
    ...
    % text5319
    \path[fill=black,line join=miter,line cap=butt,line width=0.800pt]
      (375.5305,632.6974) node[above right] (text5319) {M/L 11};

    % text5319-3
    \path[fill=black,line join=miter,line cap=butt,line width=0.800pt]
      (465.2651,632.7798) node[above right] (text5319-3) {M/L12};

    % text7847
    \path[fill=black,line join=miter,line cap=butt,line width=0.800pt]
      (442.0128,693.9413) node[above right] (text7847) {OUT5};
    ...
    % text11321
    \path[fill=black,line join=miter,line cap=butt,line width=0.800pt]
      (511.8738,282.2976) node[above right] (text11321) {Amplifier};
