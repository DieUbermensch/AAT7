...
\draw  (-4,2.38) rectangle node[text width=2cm,align=center,below=5.5] {Buffer}(-6,0.94);
\draw  (0,2.38) rectangle node[text width=2cm,align=center] {Wiener- Hopf}(2,0.94);
