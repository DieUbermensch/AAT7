...
\begin{tikzpicture}
\draw  (-3,4.93) rectangle node[text width=2cm,align=center] {ADC \& Anti-aliasing filter} (-0.86,3.43);
...
\draw  (2.77,4.93) rectangle node[text width=2cm,align=center] {ADC \& Anti-aliasing filter}(4.91,3.43);
