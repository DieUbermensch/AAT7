...
The general solutions in ANC are described thoroughly by Hansen et al. \cite{Hansen2}\cite{Hansen}. The solution used as a reference in this paper is the digital feedforward system using the FXLMS adaptive method. 

To increase bandwidth a prediction algorithm is proposed as a potential solution. In order to predict certain signal characteristics must be known, therefore speech is chosen as the noise source. Prediction of speech is described by     
