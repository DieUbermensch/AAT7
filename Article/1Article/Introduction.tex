...
\begin{figure}[H]
	...
	\caption{Denon AH-GC20, Bose QC25, Bose QC15 and Beoplay H8 measured in anechoic chamber, averaged over five measurements where the headphones was refitted between measurements. Results are filtered using a class 0 1/3 octave filter bank \cite{OctaveBand}. The purple line has negative attenuation above 1 $k$Hz according to the measurement, the gain is not perceived when using the headphone.}
