...
The problem of a feedforward system, shown in figure \ref{fig:SystemOverview}, is the dependency of the system delay being smaller than the propagation time from the noise measured (1), to the error microphone (3). 
\begin{figure}[H]
	\centering
