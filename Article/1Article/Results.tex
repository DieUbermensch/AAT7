...
\begin{figure}[H]
	...
	\caption{$PG$ as a function of different $N$ and $O$ with $P=43$. $N$ and $O$ are in hundreds. The tested points are the corner points.}
	\label{fig:Predict43}
\end{figure}
...
\begin{figure}[H]
	...
	\caption{$PG$ as a function of different $N$ and $O$ with $P=10$. $N$ and $O$ are in hundreds. The tested points are the corner points.}
	\label{fig:Predict10}
\end{figure}
