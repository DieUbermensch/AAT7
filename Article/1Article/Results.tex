...
\begin{figure}[H]
	...
	\label{fig:Predict43}
\end{figure}
With $P=43$ the optimal parameters for the predictor was found in \autoref{fig:Predict43} to be $N=1700$ and $O=1600$ based on maximizing $PG$. The optimum $PG$ is equal to 5.4 dB.
