...
\begin{figure}[H]
	...
	\caption{Frequency response of feedforward FXLMS (blue) compared with feedforward LP FXLMS (red). Results was smoothed using polynomial fits with a tolerance of $\pm$ TBD.}
