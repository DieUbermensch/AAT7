...
\begin{description}
	\item[\text{$b_j(k)$}] is the weight coefficients of the control filter written as  $b(k)=[b_0(k),b_1(k), \cdots, b_{L-1}(k)]^T$
...
\begin{figure}[H]
	\centering
	\includegraphics[width=\columnwidth]{missingfigure}
