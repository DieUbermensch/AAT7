...
{eq:Cost} using the chosen parameters 15,000 instructions are needed pr sample. The cost can be lowered by lowering fs or by choosing smaller N and O, however this will decrease the performance of the system.  
