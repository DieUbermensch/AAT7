...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item At  $f_s = 48$ $k$Hz: $P=43$, $P=10$
		\item At  $f_s = 12$ $k$Hz: $P=3$ 
	\end{itemize}
	\item Feedforward FXLMS	
	\begin{itemize}
		\item Attenuation with different delays
		\item Frequency response
		\item At  $f_s = 48$ $k$Hz,  $f_s = 12$ $k$Hz 
	\end{itemize}
	\item Listening
\end{itemize}
\end{frame}
...
\begin{columns}
		...
		\begin{itemize}
			...
			\begin{itemize}
				...
				\item Feedforward FXLMS
			\end{itemize}
			\item Sound files are resampled to used $f_s$ 
		\end{itemize}
		\end{column}
...
\begin{itemize}
	...
	\item $f_s = 44.1$ $k$Hz 
	\item Measured in an anechoic chamber		
\end{itemize}
\end{frame}
...
\begin{columns}
	...
	\begin{itemize}
		...
		\begin{itemize}
				\item[\textcolor{MATLABorange}{---}] Feedforward LP FXLMS $f_s= 48$ $k$Hz 
...
\begin{columns}
	...
	\begin{itemize}
		...
		\begin{itemize}
				\item[\textcolor{MATLABorange}{---}] Feedforward LP FXLMS $f_s= 48$ $k$Hz 
				\item[\textcolor{MATLABpurple}{---}] Feedforward LP FXLMS $f_s= 12$ $k$Hz 
				\item[\textcolor{MATLABblue}{---}] Feedforward FXLMS 
		\end{itemize}
	\end{itemize}
	\end{column}
...
\item Total
\begin{itemize}
		\item[\textcolor{MATLABblue}{---}] $f_s=48$ $k$Hz, $P=43$
		\item[\textcolor{MATLABorange}{---}] $f_s=48$ $k$Hz, $P=10$ 
		\item[\textcolor{MATLABpurple}{---}] $f_s=12$ $k$Hz, $P=3$  
\end{itemize}
\item ACF Estimation
\begin{itemize}
...
\item FXLMS
\begin{itemize}
\item Order of control filter $\cdot$ 4 
\end{itemize}
...
%    enlarge x limits  = 0.02,
  ...
  \addplot[color=MATLABpurple,fill=MATLABpurple] coordinates {(960,FxLMS)         (900,Wiener Filtering)
                         (1800,Levinson-Durbin)  (3600,ACF Estimation) (7260,Total)};
  \addplot[color=MATLABorange,fill=MATLABorange] coordinates {(3840,FxLMS)         (12000,Wiener Filtering)
                         (14400,Levinson-Durbin)  (28800,ACF Estimation) (59040,Total)};
  \addplot[color=MATLABblue,fill=MATLABblue] coordinates {(3840,FxLMS)         (51600,Wiener Filtering)
...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item Attenuation not improved by LP
	\end{itemize}
\end{itemize}
\end{frame}
