...
\begin{frame}{Filtered-$x$ Least mean squares}{Adaptive FXLMS Algorithm}
	...
	\begin{columns}
		...
		\begin{itemize}
		\item[] $\frac{\partial s[n]}{\partial b[n]} = [b_j[n] * x[n]]* \hat{c}[n]$
		\end{itemize}			
		\end{itemize}
		\end{center}	
...
\begin{tabular}[c]{@{}c@{}}Prediction\\ Length\end{tabular}   & 43  &\textcolor{MATLABblue}{22} & \textcolor{MATLABred}{22} & \textcolor{MATLAByellow}{6}  & \textcolor{MATLABgreen}{3}  \\ \hline
\end{tabular}
\end{table}
\vspace{3mm}
...
\addplot[mark=none, MATLABblue,very thick] coordinates {(24000,0) (48000,0) (96000,-60)};
\addplot[mark=none, MATLABred,very thick] coordinates {(12000,0) (24000,0) (48000,-60)};
\addplot[mark=none, MATLAByellow,very thick] coordinates {(6000,0) (12000,0) (24000,-60)};
\addplot[mark=none, MATLABgreen,very thick] coordinates {(10,0) (6000,0) (12000,-60)};
\end{axis}
\end{tikzpicture}
}
		\end{center}	
